...
This project is a 2D turn-based strategy game built in Python using [Pygame](https://www.pygame.org/). Inspired by tactical classics, it offers a grid-based combat experience where players command units, construct buildings, and battle against AI-controlled enemies.

## Features

- **Classic Turn-Based Gameplay:**  
  Command your units across a grid-based map, making strategic decisions each turn.
- **AI Opponents:**  
...
- **Resource Management:**  
  Build and manage structures to increase your capabilities and population limits.
- **Custom UI Elements:**  
  Includes translucent message boxes and pop-up notifications.
